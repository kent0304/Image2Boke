...
def main(args):
    ...
    text_list = unpickle('./data/text_list.pkl')
    tok = MecabTokenizer()
    ...
    vocab = build_vocab_custom(tokenized_text_list, threshold=args.threshold) # ユーモアを引き出したいので閾値は0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--threshold', type=int, default=0, # ユーモアを引き出したいので閾値は0
