...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='models/encoder-48-110.pth', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='models/decoder-48-110.pth', help='path for trained decoder')
